...
<div class="container">
     <div class="row">
        ...
        <div class="col-md-6 ">
            <form action="<?php echo base_url();?>user_profile/insert_education" method="post" >
            <table class="table table-bordered" style="margin-bottom:0px" >
                ...
                <tr>
                    ...
                    <td class="col-md-4">
                        <?php echo ucwords($this->muse->display_edu_info($edu_where,'edu_level')); ?>
                    </td>
                </tr>
                <tr><td class="col-md-2"> Education Field</td>
                    <td class="col-md-4">
                       <?php echo ucwords($this->muse->display_edu_info($edu_where, 'edu_field')); ?>
                    </td>
                </tr>
                <tr><td class="col-md-2"> Working With </td>
                    <td class="col-md-4">
                       <?php echo ucwords($this->muse->display_edu_info($edu_where, 'work_with')); ?>
                    </td>
                </tr>
                <tr><td class="col-md-2"> Working As  </td>
                    <td class="col-md-4">
                        <?php echo ucwords($this->muse->display_edu_info($edu_where, 'work_as')); ?>
                    </td>
                </tr>
                <tr><td class="col-md-2"> Annual Income </td>
                    <td class="col-md-4">
                        <?php echo ucwords($this->muse->display_edu_info($edu_where, 'annual_income')); ?>
                    </td>
                </tr>
                <tr>
...
<!-- Modal HTML block b-->
    <div id="myModal" class="modal fade" role="dialog">
	    ...
	    <form action="<?php echo base_url();?>update_profile/update_education" method="post" >
