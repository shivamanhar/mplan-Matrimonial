...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
   ...
   <!--  <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		...
		<div class="row">
			...
			<div class="register col-md-9 col-sm-7 col-xs-12 col-lg-5" id='mm' style="margin-bottom:10px;margin-top:3%;">
			...
			<form action="<?php echo base_url();?>auth/login" method="post" class='nicely'>
				...
				<td class="col-xs-8 .col-sm-6" style="border:none;padding:0px;" colspan="2"> <?php echo form_input($login); ?> </td>
                            </tr>
                            <tr>
                                <td style="border:none;padding:0px;" colspan="2"> <?php echo form_password($password); ?> </td>
                            </tr>
                            <tr>
                                <td style="border:none;padding:0px;width:40%;" >
            ...
            <div class="row">
                ...
                <div class="register col-md-9 col-sm-7 col-xs-12 col-lg-5" id='mm'>
                   <!-- User Register -->
...
<select name="year" id="year"  style="width:100px" required>
    ...
    <option value="1946" label="1946">1946</option>
                            ...
                            <tr>
                                <td style="border:none;padding:0px;"> <input type="checkbox" name="terms_conditions" checked> I agree to the <a href="<?php echo base_url();?>privacypolicy"> Privacy Policy </a> and <a href="<?php echo base_url();?>terms-conditions"> T&C </a></td>
                            </tr>
                            <tr>
				<td>
